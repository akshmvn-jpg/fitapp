...
<head>
    ...
    <style>
        ...
        .data-row:nth-child(odd) {<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <style>
        ...
        .app-container {
            /* This ensures the whole app fills the screen and centers content */
            min-height: 100vh;
            padding: 4px; /* Slight padding to prevent edge clipping */
        }
        .card {
            box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.4), 0 4px 6px -4px rgba(0, 0, 0, 0.2);
        }
...
<body class="bg-gray-900 text-gray-200">
    <!-- NEW: App container to isolate content -->
